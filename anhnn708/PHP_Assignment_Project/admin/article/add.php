...
if (isset($_FILES['post-thumbnail'])) {
	...
	if (!move_uploaded_file($img_tmp, '../../uploads/thumbnail/'.$img_name)) {
		...
		$query = "insert into post (cate_id, feature_image, title, content, author) values (:cate_id, :img, :title, :content, :auth)";
		...
		$records->execute(array('cate_id'=>$id, 'img'=>$img_name, 'title'=>$title, 'content'=>$content, 'auth'=>$author));

		$message_success = 'Đăng bài thành công';
                  ...
                  <hr>
                	...
                	<div class="row">
										<form action="#" method="post" name="create-post" class="form-horizontal" enctype="multipart/form-data">
												...
												<?php endif ?>
												<h2 class="text-center">Đăng bài viết mới <small class="text-danger">(Vui lòng điền đủ thông tin)</small></h2>
												<br>
									    ...
									    <div class="form-group">
									      ...
									      <div class="col-sm-8">
								          <input type="text" class="form-control" id="post-title" aria-describedby="post-title" required placeholder="Nhập tiêu đề bài viết" name="post-title" required>
									      </div>
									    </div>

									    <div class="form-group">
									      <label for="post-thumbnail" class="col-sm-3 control-label">Hình ảnh:</label>
									      <div class="col-sm-8">
									      ...
									      <div class="col-sm-8">
									        <textarea name="post-content" class="form-control" id="post-content" rows="6" required></textarea>
									      </div>
									    </div>
									    <script>
									    ...
									    <div class="form-group">
									      ...
									      <div class="col-sm-8">
									        <button type="submit" class="btn btn-lg btn-success" id="submit_post">Đăng bài</button>
